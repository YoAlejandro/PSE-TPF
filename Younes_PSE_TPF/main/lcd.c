...
#if LCD_CTRL_MODE == 4
    *LCD_DATA_DDR =
        (1 << LCD_D0) | (1 << LCD_D1) | (1 << LCD_D2) | (1 << LCD_D3);
#else
    *LCD_DATA_DDR = (1 << LCD_D0) | (1 << LCD_D1) | (1 << LCD_D2) |
...
// put the LCD into 4 bit or 8 bit mode
    ...
    write_4_bit(0x03);
    delay_10us_n(450);  // wait min 4.1ms
...
void liquidCrystal_clear() {
    ...
    delay_10us_n(200);        // this command takes a long time!
}
...
static void pulse_enable(void) {
    ...
    delay_5us();
    LCD_SET_EN_BIT;
    delay_5us();  // enable pulse must be >450ns
    LCD_CLR_EN_BIT;
    delay_10us_n(10);  // commands need > 37us to settle
}
